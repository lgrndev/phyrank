...
function Footer () {
    return (
        <div className='lg:ml-40 lg:mr-40 lg:mt-20 md:ml-20 md:mr-20 md:mt-10 ml-8 mr-8 mt-4 mb-8'>
            ...
            <div className='flex flex-col justify-between mt-8 sm:flex-row items-center'>
                <div className='text-zinc-300 flex flex-row sm:gap-10 text-sm gap-8'>
                ...
                <div className='text-zinc-400 text-sm mt-4 sm:mt-0'>
